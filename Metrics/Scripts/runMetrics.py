...
metricData = pd.read_csv("/Users/michaelpoblacion/Documents/VCU/Fall19/CMSC435/Protein-Classification/PreProcessing/PFeature/PFeature_CharCombined_SMOTE_RandomForest.csv", sep=';', header=None)
